...
<div class="wrap">
  ...
  <div class="scan-panel">
    <form id="scan-form">
      ...
      <label class="single-page-field"><input type="checkbox" id="single-page-checkbox" /> Only this page (no sitemap/crawl)</label>
